...
//     // Update game speed based on score (usando velocidade base que você definiu)
//     const newSpeed = 0.5 + Math.floor(gameState.score / 750) * 0.1;
...
//                 <p className="mb-4 text-lg">Toque nas laterais da tela para mover</p>
...
//               {/* Botão Esquerda */}
//               <div 
//                 className="absolute left-4 bottom-4 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30"
//                 onTouchStart={(e) => {
//                   e.preventDefault();
//                   gameDataRef.current.keys.left = true;
//                   gameDataRef.current.keys.right = false;
...
//               {/* Botão Direita */}
//               <div 
//                 className="absolute right-4 bottom-4 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30"
//                 onTouchStart={(e) => {
//                   e.preventDefault();
//                   gameDataRef.current.keys.right = true;
//                   gameDataRef.current.keys.left = false;
...
//           <p>Toque e segure os botões ← → ou nas laterais da tela</p>
//           <p>Velocidade aumenta a cada 500 pontos!</p>
//         </div>
//       </div>
//     </div>
//   );
    ...
    <div className="flex flex-col h-screen bg-gradient-to-b from-primary/5 to-secondary/5">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        <div className="relative border-2 border-primary/20 rounded-lg overflow-hidden shadow-2xl">
          ...
          {!gameState.isPlaying && !gameState.gameWon && !gameState.isCountingDown && (
            <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
              <div className="text-center text-white p-6">
                <h3 className="text-3xl font-bold mb-4">Plataforma Ascent</h3>
      ...
      <div className="p-4 bg-background/95 backdrop-blur-sm border-t">
        <div className="text-center text-sm text-muted-foreground max-w-md mx-auto">
          <p className="font-medium">🎮 CONTROLES TOUCHSCREEN</p>
          <p>Toque e segure os botões ← → ou nas laterais da tela</p>
          <p>Velocidade aumenta gradualmente a cada 12 plataformas!</p>
        </div>
      </div>
    </div>
  );
